...
export function BouncingBasketball({ size = 56, className = '' }: BouncingBasketballProps) {
  return (
    <div className={`relative flex items-center justify-center ${className}`} style={{ height: size * 2 }}>
      {/* Shadow */}
      <div 
        className="absolute bottom-0 rounded-full bg-black/30 blur-md animate-shadow-pulse"
        style={{ 
          width: size * 0.8,
          height: size * 0.15,
        }}
      ...
      {/* Basketball */}
      <div className="absolute animate-basketball-bounce">
        <svg
          width={size}
          height={size}
          viewBox="0 0 64 64"
          xmlns="http://www.w3.org/2000/svg"
          className="animate-basketball-spin"
